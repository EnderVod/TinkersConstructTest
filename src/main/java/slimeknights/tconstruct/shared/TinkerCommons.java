...
public final class TinkerCommons extends TinkerModule {
  ...
  public static final ItemObject<TransparentBlock> soulGlass = BLOCKS.register("soul_glass", () -> new SoulGlassBlock(glassBuilder(MapColor.COLOR_BROWN).speedFactor(0.2F).noCollission().forceSolidOn().isViewBlocking((state, getter, pos) -> true)), TOOLTIP_BLOCK_ITEM);
...
public static final DeferredHolder<MapCodec<? extends ICondition>, MapCodec<TagNotEmptyCondition<?>>> tagNotEmptyCondition = CONDITION_CODECS.register(TagNotEmptyCondition.ID.getPath(), () -> TagNotEmptyCondition.CODEC);
  ...
  @SuppressWarnings("removal")
  @Deprecated(forRemoval = true)
  public static final DeferredHolder<? super LootPoolEntryType, LootPoolEntryType> lootTagPreference = LOOT_ENTRIES.register("tag_preference", () -> new LootPoolEntryType(new TagPreferenceLootEntry.Serializer()));
