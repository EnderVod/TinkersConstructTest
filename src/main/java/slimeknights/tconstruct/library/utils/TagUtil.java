...
public final class TagUtil {
  /** Registry lookup for serializing vanilla registry-backed stacks outside a level context. */
  ...
  /** Checks if the stack has non-empty custom data. */
  public static boolean hasTag(ItemStack stack) {
    return stack.has(DataComponents.CUSTOM_DATA);
  }

  /* Fluid custom data helpers */
  ...
  /** Checks if the fluid stack has non-empty custom data. */
  ...
  /** Creates a fluid stack and applies a legacy custom-data tag if present. */
